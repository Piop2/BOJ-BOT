...
def make_problem_thumbnail(problem: Problem):
    ...
    title_font = pygame.font.SysFont(name="malgungothic", size=150, bold=True)
    title_text = title_font.render(problem.title, True, (0, 0, 0))

    tag_font = pygame.font.SysFont(name="malgungothic", size=35, bold=True)
    ...
    surf.blit(title_text, (290, 298 - (title_text.get_height() / 2)))
    surf.blit(tag_text, (290, 480 - tag_text.get_height()))
